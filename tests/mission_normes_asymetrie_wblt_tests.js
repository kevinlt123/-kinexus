...
const BASELINE_COMMIT = 'HEAD'; // dernier commit avant cette mission (working tree = seul diff de cette mission)
...
test('GUARD 1 — les 8 moteurs HYP-XX-01 LOCKED restent BYTE-IDENTIQUES (HEAD, avant cette mission)', () => {
