...
test('GUARD 6 — CSM_V2_CLINICAL_VARIABLE_MATRIX : formule de dérivation (IIFE) inchangée ; seul son résultat évolue, exactement à hauteur de MISSION_HYP_EXP01_RSI_MOD (ajout de cmj_rsi_mod au diagnosticEvidence d\'Explosivité, sans rapport avec cette mission WBLT)', () => {
  ...
  // mission WBLT) : csmV2VariableMatrixClassifiability() consulte désormais aussi NORMS, en plus de
  // THRESHOLDS/NORMS_V2 — 18 entrées variable/rôle déjà existantes changent de classifiability,
  // réparties sur Absorption/Force/Puissance/Endurance (jamais une variable inventée).
